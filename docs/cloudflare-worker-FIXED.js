...
// FIXED VERSION - Met de juiste PREVIEW_URL
// BELANGRIJK: Update PREVIEW_URL naar uw huidige Emergent preview URL
...
export default {
  async fetch(request) {
    ...
    // IMAGES: Proxy to backend API which serves from local files
