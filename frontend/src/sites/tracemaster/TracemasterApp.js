...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" data-testid="contact-form">
      ...
      <button
        type="submit"
        className="w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-[1.02] shadow-lg flex items-center justify-center gap-3"
      ...
      <p className="text-gray-500 text-sm text-center">
        Al hacer clic en "Enviar", se abrirá su aplicación de correo electrónico con el mensaje preparado.
      </p>
    </form>
  );
};
