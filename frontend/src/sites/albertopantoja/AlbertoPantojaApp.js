  ...
  es: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Antes de asumir el cargo de Concejal, ejerció durante 3 años como Presidente de la parroquia San Gabriel del Baba, en la misma provincia de Santo Domingo de los Tsáchilas. Fue en esa etapa donde consolidó su liderazgo territorial y su cercanía con las comunidades rurales.',
  ...
  fr: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Avant d\'occuper le poste de Conseiller, il a exercé pendant 3 ans les fonctions de Président de la paroisse de San Gabriel del Baba, dans la même province de Santo Domingo de los Tsáchilas. C\'est durant cette étape qu\'il a consolidé son leadership territorial et sa proximité avec les communautés rurales.',
  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'In the early 2000s, like so many Ecuadorians of his generation, he set out for Europe in search of new opportunities. For 18 years he lived in Belgium, where he worked, studied and built a life marked by discipline and resilience. Those years allowed him to gain first-hand knowledge of European public-management systems, community organization and social welfare policies.',
        ...
        'Before taking office as Councilman, he served for 3 years as President of the parish of San Gabriel del Baba, in the same province of Santo Domingo de los Tsáchilas. It was during that time that he built his territorial leadership and his closeness to rural communities.',
