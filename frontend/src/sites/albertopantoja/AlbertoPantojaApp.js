...
const WORKING_VIDEOS = [
  ...
  {
    type: 'facebook_reel',
    url: 'https://www.facebook.com/reel/1744019743294203',
    title: 'Reel 8'
  },
  {
    type: 'facebook_reel',
  ...
  {
    type: 'tiktok',
    id: '7651831616511298824',
    url: 'https://www.tiktok.com/@albertopantojasgb/video/7651831616511298824',
    title: 'TikTok 2'
  },
  {
    type: 'tiktok',
    id: '7644189409973161234',
...
const IMAGES = {
  ...
  profileMain: IMG('/images/albertopantoja/Alberto/500393636_10162668089614803_5713977786309093269_n.jpg'),
...
const AlbertoPantojaApp = () => {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Manrope', sans-serif" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Location indicator */}
              <div className="relative inline-flex mb-6 group animate-float-gentle" data-testid="candidacy-banner">
      ...
      {/* Photo Gallery Section (moved above Work Areas) */}
      ...
      {/* Work Areas Section (moved below gallery) */}
      <section id="work" className="py-20 md:py-32 bg-gray-50" data-testid="work-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header */}
          <div className="text-center mb-16">
            <p className="text-red-600 text-xs font-semibold tracking-[0.2em] mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-8">
            {t.work.areas.map((area, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-xl md:rounded-2xl p-4 md:p-8 hover:shadow-lg transition-shadow border-l-4 border-blue-600"
