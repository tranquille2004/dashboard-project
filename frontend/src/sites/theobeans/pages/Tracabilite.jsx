  ...
  return (
    <div className="min-h-screen pt-16 bg-[#F5EDE0]">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(109, 76, 65, 0.70), rgba(109, 76, 65, 0.70)), url(${IMG('/images/gallery/tracabilite-hero.jpg')})`,
      ...
      <section className="py-12 md:py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Elements List */}
          <div className="bg-[#F5EDE0] p-6 md:p-8 rounded-lg mb-10 shadow-md">
            <div className="grid md:grid-cols-2 gap-4">
              {t.tracabilite.elements.map((element, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <CheckCircle className="text-[#6D4C41] flex-shrink-0 mt-1" size={20} />
