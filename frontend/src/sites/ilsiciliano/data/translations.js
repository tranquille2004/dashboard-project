...
export const translations = {
  ...
  home: {
    ...
    subtitle: _(
      'donde cada plato es un pequeño viaje en Italia',
      'where every dish is a small journey to Italy',
      'dove ogni piatto è un piccolo viaggio in Italia',
      'où chaque plat est un petit voyage en Italie'
    ),
    closedNotice: _('', '', '', ''),
    cta: {
  ...
  about: {
    ...
    content: {
      es: `Il Siciliano nació del sueño de traer a Santo Domingo los sabores auténticos de Italia — directamente desde las trattorias familiares, donde la comida es un gesto de amor y la mesa se llena de conversación y risas.\n\nNuestra cocina se basa en tres pilares simples pero esenciales: productos frescos, recetas transmitidas de generación en generación, y la paciencia que exige la verdadera gastronomía italiana. Amasamos la pasta a mano cada día y seleccionamos los ingredientes con el cuidado de quien cocina para la propia familia.\n\nDesde los ravioli hasta la pasta alla Norma, desde la pizza margherita más clásica hasta las especialidades del chef, cada plato cuenta una historia. Una historia donde el mar se mezcla con el aroma del limón, albaca y el aceite de oliva.\n\nBienvenidos a Il Siciliano — donde cada comida es una pequeña vacación en Italia.`,
      en: `Il Siciliano was born from the dream of bringing to Santo Domingo the authentic flavors of Italy — straight from the family trattorias, where food is a gesture of love and the table fills up with conversation and laughter.\n\nOur kitchen is built on three simple but essential pillars: fresh produce, recipes handed down from generation to generation, and the patience that true Italian cuisine demands. We knead our pasta by hand every day and pick our ingredients with the care of someone cooking for their own family.\n\nFrom ravioli to pasta alla Norma, from the most classic pizza margherita to the chef's specialties, every dish tells a story. A story where the sea blends with the aroma of lemons, basil and olive oil.\n\nWelcome to Il Siciliano — where every meal is a small vacation in Italy.`,
      it: `Il Siciliano nasce dal sogno di portare a Santo Domingo i sapori autentici d'Italia — direttamente dalle trattorie familiari, dove il cibo è un gesto d'amore e la tavola si riempie di conversazione e risate.\n\nLa nostra cucina si basa su tre pilastri semplici ma essenziali: prodotti freschi, ricette tramandate di generazione in generazione, e la pazienza che la vera gastronomia italiana richiede. Impastiamo la pasta a mano ogni giorno e selezioniamo gli ingredienti con la cura di chi cucina per la propria famiglia.\n\nDai ravioli alla pasta alla Norma, dalla pizza margherita più classica alle specialità dello chef, ogni piatto racconta una storia. Una storia dove il mare si mescola con il profumo del limone, basilico e dell'olio d'oliva.\n\nBenvenuti a Il Siciliano — dove ogni pasto è una piccola vacanza in Italia.`,
      fr: `Il Siciliano est né du rêve d'apporter à Santo Domingo les saveurs authentiques d'Italie — directement des trattorias familiales, où la nourriture est un geste d'amour et où la table se remplit de conversation et de rires.\n\nNotre cuisine repose sur trois piliers simples mais essentiels : des produits frais, des recettes transmises de génération en génération, et la patience que la vraie gastronomie italienne exige. Nous pétrissons nos pâtes à la main chaque jour et choisissons nos ingrédients avec le soin de quelqu'un qui cuisine pour sa propre famille.\n\nDes ravioli aux pâtes alla Norma, de la pizza margherita la plus classique aux spécialités du chef, chaque plat raconte une histoire. Une histoire où la mer se mélange à l'arôme du citron, du basilic et de l'huile d'olive.\n\nBienvenue chez Il Siciliano — où chaque repas est une petite vacance en Italie.`,
      nl: '',
      de: ''
    }
  },
