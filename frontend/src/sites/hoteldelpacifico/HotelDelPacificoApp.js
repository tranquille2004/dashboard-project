...
const translations = {
  es: {
    ...
    hero: {
      ...
      subtitle: 'Un oasis de tranquilidad y elegancia en el corazón de Santo Domingo de los Tsáchilas, Ecuador',
      cta: 'Reservar Ahora',
  ...
  en: {
    ...
    hero: {
      welcome: 'Welcome to',
      title: 'Hotel del Pacífico',
      subtitle: 'An oasis of tranquility and elegance in the heart of Santo Domingo de los Tsáchilas, Ecuador',
      cta: 'Book Now',
  ...
  fr: {
    ...
    hero: { welcome: 'Bienvenue au', title: 'Hotel del Pacífico', subtitle: 'Une oasis de tranquillité et d\'élégance au cœur de Santo Domingo de los Tsáchilas, Équateur', cta: 'Réserver', explore: 'Découvrir' },
  ...
  it: {
    ...
    hero: { welcome: 'Benvenuti al', title: 'Hotel del Pacífico', subtitle: 'Un\'oasi di tranquillità ed eleganza nel cuore di Santo Domingo de los Tsáchilas, Ecuador', cta: 'Prenota Ora', explore: 'Scopri di Più' },
  ...
  de: {
    ...
    hero: { welcome: 'Willkommen im', title: 'Hotel del Pacífico', subtitle: 'Eine Oase der Ruhe und Eleganz im Herzen von Santo Domingo de los Tsáchilas, Ecuador', cta: 'Jetzt Buchen', explore: 'Mehr Entdecken' },
